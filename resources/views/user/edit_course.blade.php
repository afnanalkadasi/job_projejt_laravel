...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> تعديل   الدورة</h4>

            <!-- Multi Column with Form Separator -->
            <div class="card mb-4">
              <form class="card-body" action="{{ route('update_course',$course->id) }}" method="POST" >
              @csrf
              <div class="row g-3">
                  <div class="col-md-6">
                    <label class="form-label" for="multicol-username">اسم  الدورة</label>
                    <input name="name" type="text"value="{{ $course->name }}" id="multicol-username" class="form-control" placeholder="" />
                  </div>
                
                  <div class="col-md-6">
                    <label for="exampleFormControlTextarea1" class="form-label">الدرجة </label>
                    <input name="degree" type="text"value="{{ $course->degree }}" id="multicol-username" class="form-control" placeholder="" />
                  </div>
