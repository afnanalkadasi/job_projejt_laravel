...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> تعديل المهارة </h4>
              ...
              @csrf
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input name="name" value="{{ $skill->name }}" type="text" id="multicol-username" class="form-control" placeholder="" />
