...
<g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
    ...
    <span class="app-brand-text demo menu-text fw-bolder ms-2"> Job Dashbord </span>
  </a>
...
<div class="menu-inner-shadow"></div>
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="الوظيفة">الوظيفة</div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
  ...
  <li class="menu-item">
    ...
    <li class="menu-item">
        <a href="{{ route('add_service') }}" class="menu-link">
          <div data-i18n="اضافة خدمة">اضافة خدمة</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="{{ route('services') }}" class="menu-link">
          <div data-i18n="عرض الخدمات">عرض الخدمات</div>
        </a>
      </li>
  ...
  <li class="menu-item">
    ...
    <li class="menu-item">
        <a href="{{ route('add_company') }}" class="menu-link">
          <div data-i18n="اضاقة شركة">اضافة شركة</div>
        </a>
      </li>

      <li class="menu-item">
        <a href="{{ route('companies') }}" class="menu-link">
          <div data-i18n="عرض الشركات">عرض الشركات</div>
        </a>
      </li>
