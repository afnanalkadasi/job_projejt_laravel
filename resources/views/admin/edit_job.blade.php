...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> تعديل وظيفة </h4>
            ...
            <div class="card mb-4">
              ...
              <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input name="name" type="text" value="{{ $job->name }}" id="multicol-categoryname" class="form-control" placeholder="" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="multicol-categoryname">موقع الوظيفة</label>
                    <input name="place" type="text" value="{{ $job->place }}" id="multicol-categoryname" class="form-control" placeholder="" />
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="date" name="start_date"  value="{{ $job->start_date }}" id="multicol-birthdate" class="form-control dob-picker" placeholder="YYYY-MM-DD" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="multicol-birthdate"> تاريخ النهاية</label>
                    <input type="date" name="end_date"  value="{{ $job->end_date }}" id="multicol-birthdate" class="form-control dob-picker" placeholder="YYYY-MM-DD" />
                  </div>
                  <div class="col-md-6">
                    <label class="form-label" for="multicol-categoryname"> الراتب</label>
                    <input name="salary" type="text"  value="{{ $job->salary }}" id="multicol-categoryname" class="form-control" placeholder="" />
                  </div>
          ...
          <textarea name="description" class="form-control"  value="{{ $job->description }}" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
