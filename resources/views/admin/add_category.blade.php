...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> اضافة القسم </h4>
            @if ($errors->any())
          ...
          @endforeach
            ...
            <div class="card mb-4">
              <form class="card-body" action="{{  url('admin/save_category') }}" method="POST" enctype="multipart/form-data">
              @csrf 
              <div class="row g-3">
                  <div class="col-md-6">
