...
@section('content')
 ...
 <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              ...
              <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input name="name" type="text" value="{{ $service->name }}" id="multicol-username" class="form-control" placeholder="" />
                  </div>
          ...
          <textarea name="description" value="{{ $service->description }}"  class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-password-toggle">
                      ...
                      <div class="input-group input-group-merge">
                      <label class="switch">
                          <input name="is_active"  value="{{ $service->is_active }}" type="checkbox" checked class="switch-input" />
